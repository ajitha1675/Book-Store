    ...
    <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
         ...
         <div>
          ...
          <button className="bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-8 rounded focus:outline-none ">Register</button>
         </div>
      </form>
      <p className="align-baseline font-medium mt-4 text-sm">Have a account? Please <Link to="/login" className="text-blue-500 hover:text-blue-800">Login</Link></p>
